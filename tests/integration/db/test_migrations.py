...
async def test_ca_3_01_alembic_upgrade_head_deja_la_base_en_la_revision_actual():
    ...
    La revision "head" avanza con cada migracion nueva (issue #14 agrego
    `20260815_100000` encadenada via `down_revision` a `20260815_090000`
    (issue #12), que a su vez fue agregada encima de `20260814_201500`,
    issue #11) — el valor esperado se actualiza junto con la ultima
    ...
    assert version == "20260815_100000"
