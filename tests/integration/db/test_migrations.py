...
async def test_ca_3_01_alembic_upgrade_head_deja_la_base_en_la_revision_actual():
    ...
    La revision "head" avanza con cada migracion nueva (issue #124 agrego
    `20260831_200000_add_contract_delete_permission.py` encadenada via
    `down_revision` a `20260829_100000` (issue #119)) — el valor esperado
    se actualiza junto con la ultima migracion del repo; ver
    ...
    assert version == "20260831_200000"
