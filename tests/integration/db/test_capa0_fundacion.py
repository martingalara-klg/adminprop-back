...
async def test_ca_5_01_alembic_upgrade_head_deja_la_base_en_la_revision_actual():
    ...
    Issue #124 agrego `20260831_200000_add_contract_delete_permission.py`
    encadenada via `down_revision` a `20260829_100000_add_payments_origin.py`
    (issue #119) -- el head se actualiza a esa revision.
    """
    engine = get_engine()
