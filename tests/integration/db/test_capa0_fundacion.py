...
async def test_ca_5_01_alembic_upgrade_head_deja_la_base_en_la_revision_actual():
    ...
    Issue #19 agrego `20260819_123059_add_contracts_expiring_notified_at.py`
    encima de `20260815_110000_create_capa3_contratos.py` (issue #16) -- el
    head se actualiza a esa revision.
    """
    engine = get_engine()
