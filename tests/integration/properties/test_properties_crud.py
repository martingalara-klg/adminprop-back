...
SDD: docs/sdd/features/spec_module_01_propiedades.md RF-01, RF-04.
Implements: CA-01-01.
"""
...
class TestCA0101CreatePropertyAppearsInListingAndLandlordFicha:
    ...
    async def test_ca_01_01_created_property_appears_in_listing(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "Calle Unica 111", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
    ...
    async def test_ca_01_01_created_property_appears_in_landlord_ficha(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "Calle De La Ficha 222", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
    ...
    async def test_create_property_with_nonexistent_landlord_returns_404(self, client, seed):
        ...
        response = await client.post(
            "/v1/properties",
            json={"address": "Sin Propietario 000", "landlord_id": str(uuid.uuid4())},
            headers=owner["headers"],
        )
...
class TestPropertyListFilters:
    ...
    async def test_filter_by_landlord_id(self, client, seed):
        ...
        await client.post(
            "/v1/properties",
            json={"address": "Direccion De A", "landlord_id": str(landlord_a)},
            headers=owner["headers"],
        )
        await client.post(
            "/v1/properties",
            json={"address": "Direccion De B", "landlord_id": str(landlord_b)},
            headers=owner["headers"],
        )
    ...
    async def test_filter_by_status(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "En refaccion filtro", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
        await client.patch(
        ...
        await client.post(
            "/v1/properties",
            json={"address": "Disponible filtro", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
    ...
    async def test_list_properties_paginates_with_cursor(self, client, seed):
        ...
        for i in range(3):
            await client.post(
                "/v1/properties",
                json={"address": f"Direccion paginada {i}", "landlord_id": str(landlord_id)},
                headers=owner["headers"],
            )
    ...
    async def test_search_by_address_substring(self, client, seed):
        ...
        await client.post(
            "/v1/properties",
            json={"address": "Bulevar San Juan 500", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        await client.post(
            "/v1/properties",
            json={"address": "Otra direccion 900", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
...
class TestPropertyUpdate:
    ...
    async def test_update_address_and_notes(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "Direccion Original 1", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
    ...
    async def test_update_status_to_unavailable(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "En refaccion 3", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
    ...
    async def test_update_status_to_rented_is_rejected_rf04(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "No debe alquilarse manualmente 4", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
    ...
    async def test_update_property_type(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "Cambia de tipo 8", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
    ...
    async def test_update_landlord_id_to_nonexistent_returns_404(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "Cambio de dueno 5", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
    ...
    async def test_update_landlord_id_is_audited(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "Cambia de dueno 6", "landlord_id": str(landlord_a)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
...
class TestPropertyFicha:
    ...
    async def test_ficha_includes_placeholders_for_future_modules(self, client, seed):
        ...
        created = await client.post(
            "/v1/properties",
            json={"address": "Ficha completa 7", "landlord_id": str(landlord_id)},
            headers=owner["headers"],
        )
        property_id = created.json()["data"]["id"]
