...
| `sdd_03_api_contracts` | Contratos REST de la API | core | Activo | 1.16 | ✅ | ✅ **compartido — vinculante** |
...
| `spec_module_03_contratos` | Módulo 3 — Contratos + ajustes por índice | features | Activo | 1.6 | ✅ | ✅ |
